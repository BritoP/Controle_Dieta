...
public class AlimentoAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() { return listaAlimentos.size(); }

    @Override
    public Object getItem(int position) { return listaAlimentos.get(position); }

    @Override
    public long getItemId(int position) { return listaAlimentos.get(position).getId(); }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.textViewValorCaseira.setText(alimento.isCaseira()
                ? context.getString(R.string.receita_caseira)
                : context.getString(R.string.receita_nao_caseira));
